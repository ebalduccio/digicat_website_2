        ...
        <div className="bg-gradient-to-b from-gray-950 via-sky-900 to-sky-950 min-h-screen text-gray-100">
            ...
            <Container>
                <section className="py-24 text-center">
                    ...
                    <p className="text-xl mb-12 max-w-2xl mx-auto">Transforme seu negócio, liberte seu tempo e maximize seus resultados com automação e IA. Não espere mais – o futuro do seu negócio começa agora.</p>
